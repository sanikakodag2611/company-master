...
class EmployeeUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'email' => 'required|email|unique:employee_master,email,' . $employeeId,
            'username' => 'required|string|unique:employee_master,username,' . $employeeId,
            'password' => 'required|min:6',
            'contact_no' => 'required|string|max:15|unique:employee_master,contact_no,' . $employeeId,
            ...
            'pan_card' => [
                ...
                'unique:employee_master,pan_card,' . $employeeId,
            ],
